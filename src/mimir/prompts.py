...
{{"topic":"从下方主题列表选择","priority":"high|medium|low","overview":"这篇论文做了什么，≤200字","innovation":"核心创新点，和已有工作的区别，≤200字","significance":"为什么重要，对研究或产业的影响，≤150字"}}
...
现在处理以下内容，返回 strict JSON：
{{"topic":"从下方主题列表选择","priority":"high|medium|low","use_case":"用途说明，解决什么问题、适合什么场景，≤200字"}}
...
现在处理以下内容，返回 strict JSON：
{{"topic":"从下方主题列表选择","priority":"high|medium|low","key_point":"核心信息一句话，≤150字","verification":"verified|unverified|rumor"}}
